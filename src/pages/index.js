...
const IndexPage = () => {
    ...
    const semEndDate = new Date(2024, 11, 30);
    ...
    return (
        <>
            {/* helmet tags */}
            <Helmet>
                <title>LUMS Course Scheduler | Project Mirage (Unofficial)</title>
                {/* meta data to add:
            - description:
            ...
            */}
                ...
                />
                <meta name="author" content="Muzammil Ahmed" />
                <meta
                    name="viewport"
            ...
            <main className="Main">
                ...
                <div className="credits">
                    ...
                    <p>
                        muzammil ahmed's (25020104) rendition of Mirage{" "}
                    </p>
                    <p>
